/**
 * Created by 胡嘉杰 on 2017/1/9 0009.
 */
//全局变量部分
...
function assign() {
 ...
 alert("杀手的数组包含"+arrX);
  ...
  for (i=0;i < x;i++) {
    ...
    document.getElementById("x1").appendChild(para);//将span元素节点植入id为x1的div元素节点
  }
  ...
  for (i=0;i < y;i++) {
    ...
    para.appendChild(node);//将文本节点置入span元素节点
    document.getElementById("y1").appendChild(para);//将span元素节点植入id为y1的div元素节点
  }
